...
public class ListaEncadeada<T> {
	...
	// Esse métod o aqui é o que a professora pediu, no qual é para adicionar o
	// elemento
	...
	public No<T> returnMiddle() {
        if (this.inicio == null) {
            return null;
        }

        No<T> elemento;
        int metade = Math.round(this.tamanho / 2);
        
        elemento = this.buscaNo(metade);
